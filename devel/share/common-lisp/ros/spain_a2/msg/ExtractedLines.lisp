...
(cl:defclass <ExtractedLines> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (lines
    :reader lines
    :initarg :lines
    :type (cl:vector spain_a2-msg:ExtractedLine)
   :initform (cl:make-array 0 :element-type 'spain_a2-msg:ExtractedLine :initial-element (cl:make-instance 'spain_a2-msg:ExtractedLine))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ExtractedLines>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExtractedLines)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spain_a2-msg:<ExtractedLines> is deprecated: use spain_a2-msg:ExtractedLines instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExtractedLines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spain_a2-msg:header-val is deprecated.  Use spain_a2-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'lines-val :lambda-list '(m))
(cl:defmethod lines-val ((m <ExtractedLines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spain_a2-msg:lines-val is deprecated.  Use spain_a2-msg:lines instead.")
  (lines m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ExtractedLines>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lines)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'spain_a2-msg:ExtractedLine))
