...
(cl:in-package my_laser_lines-msg)
...
(cl:defclass <ExtractedLines> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (lines
    :reader lines
    :initarg :lines
    :type (cl:vector my_laser_lines-msg:ExtractedLine)
   :initform (cl:make-array 0 :element-type 'my_laser_lines-msg:ExtractedLine :initial-element (cl:make-instance 'my_laser_lines-msg:ExtractedLine))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ExtractedLines>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExtractedLines)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_laser_lines-msg:<ExtractedLines> is deprecated: use my_laser_lines-msg:ExtractedLines instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExtractedLines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:header-val is deprecated.  Use my_laser_lines-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'lines-val :lambda-list '(m))
(cl:defmethod lines-val ((m <ExtractedLines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:lines-val is deprecated.  Use my_laser_lines-msg:lines instead.")
  (lines m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ExtractedLines>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lines)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'my_laser_lines-msg:ExtractedLine))
