...
(cl:defmethod cl:initialize-instance :after ((m <ExtractedLine>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExtractedLine)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_laser_lines-msg:<ExtractedLine> is deprecated: use my_laser_lines-msg:ExtractedLine instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <ExtractedLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:r-val is deprecated.  Use my_laser_lines-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <ExtractedLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:alpha-val is deprecated.  Use my_laser_lines-msg:alpha instead.")
  (alpha m))

(cl:ensure-generic-function 'firstScanPoint-val :lambda-list '(m))
(cl:defmethod firstScanPoint-val ((m <ExtractedLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:firstScanPoint-val is deprecated.  Use my_laser_lines-msg:firstScanPoint instead.")
  (firstScanPoint m))

(cl:ensure-generic-function 'lastScanPoint-val :lambda-list '(m))
(cl:defmethod lastScanPoint-val ((m <ExtractedLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_laser_lines-msg:lastScanPoint-val is deprecated.  Use my_laser_lines-msg:lastScanPoint instead.")
  (lastScanPoint m))
