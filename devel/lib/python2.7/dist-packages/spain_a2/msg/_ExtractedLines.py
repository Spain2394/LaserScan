...
"""autogenerated by genpy from spain_a2/ExtractedLines.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','spain_a2/ExtractedLine[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = spain_a2.msg.ExtractedLine()
        _x = val1
        start = end
        end += 8
