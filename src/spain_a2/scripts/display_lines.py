...
if __name__ == '__main__':
    ...
    print("Barsow, we're in")
 
    #private parameters, but being used to subscribe to 
    # extracted lines topic, and publish to vizualize in rviz
    ...
    # Subscribe to '\extracted_lines' topic  as to display lines
